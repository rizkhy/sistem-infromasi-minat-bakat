...
<form class="forms-sample" enctype="multipart/form-data"  action="proses_minat_bakat.php" method="POST">
  ...
  <div class="form-group">
    ...
    <select class="form-control" name="jenis_mb">
  ...
  <?php
              ...
              while($mapel2 = mysqli_fetch_assoc($mapel)){
  ?>
  <input type="hidden" name="username" class="form-control" id="exampleInputName1" value="<?php echo $mapel2['id_member'] ?>">
  <?php 
    }
  ?>
</form>